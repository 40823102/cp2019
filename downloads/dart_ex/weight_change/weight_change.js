    ...
    call$1: function(e) {
      ...
      if (type === "L" || type === "l") {
        ...
        if (typeof number !== "number")
          return number.$mul();
        (output && C.LabelElement_methods).setInnerHtml$1(output, t1 + C.JSNumber_methods.toStringAsFixed$1(number * 0.4536, 4) + " \u516c\u65a4");
      } else {
        t1 = type === "K" || type === "k";
        ...
        if (t1) {
          ...
          if (typeof number !== "number")
            return number.$mul();
          t2.setInnerHtml$1(output, t1 + C.JSNumber_methods.toStringAsFixed$1(number * 2.2046, 4) + " \u82f1\u78c5");
        } else
